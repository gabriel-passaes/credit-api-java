...
public class UserController {
  ...
  @DeleteMapping
  @Operation(
      summary = "Remove múltiplos usuários (somente SUPER_ADMIN)",
      requestBody =
          @io.swagger.v3.oas.annotations.parameters.RequestBody(
  ...
  @Operation(
      ...
      parameters = @Parameter(name = "email", description = "E-mail do usuário"),
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Usuário encontrado",
  ...
  @Operation(
      ...
      requestBody =
          @io.swagger.v3.oas.annotations.parameters.RequestBody(
              content = @Content(schema = @Schema(implementation = UserSearchDTO.class))),
      responses = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<Page<UserResponseDTO>> search(
      @RequestBody UserSearchDTO searchDto, Pageable pageable) {
    return ResponseEntity.ok(search.execute(searchDto, pageable));
  }

  @PostMapping("/{id}/upload")
  @Operation(
      summary = "Faz upload do avatar de um usuário",
      parameters = @Parameter(name = "id", description = "ID do usuário"),
      requestBody =
          @io.swagger.v3.oas.annotations.parameters.RequestBody(
